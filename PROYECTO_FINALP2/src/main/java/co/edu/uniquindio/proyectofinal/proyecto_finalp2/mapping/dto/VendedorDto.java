...
public class VendedorDto {
    ...
    public void setProductos(List<ProductoDto> productos) { this.productos = new ArrayList<>(productos); }

    public List<VendedorDto> getContactos() { return new ArrayList<>(contactos); }
    public void setContactos(List<VendedorDto> contactos) { this.contactos = new ArrayList<>(contactos); }

    public List<String> getMuroMensajes() { return new ArrayList<>(muroMensajes); }
    public void setMuroMensajes(List<String> muroMensajes) { this.muroMensajes = new ArrayList<>(muroMensajes); }
