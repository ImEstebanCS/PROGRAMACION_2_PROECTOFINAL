...
public class Producto {
    ...
    public void setComentarios(List<Comentario> comentarios) { this.comentarios = new ArrayList<>(comentarios); }

    public List<MeGusta> getMeGusta() { return new ArrayList<>(meGusta); }
    public void setMeGusta(List<MeGusta> meGusta) { this.meGusta = new ArrayList<>(meGusta); }
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(nombre, producto.nombre) && Objects.equals(vendedor, producto.vendedor);
    }
